...
from src.DL_model.bert_models.utils.file_utils import cached_path
...
class ClsNezaBert(BertPreTrainedModel):
    def __init__(self, config, args):
        super(ClsNezaBert, self).__init__(config=config)
        self.args = args
        self.config = config
    ...
    def forward(self,
        ...
        bert_pooled_output = bert_outputs[1]  # [CLS]
