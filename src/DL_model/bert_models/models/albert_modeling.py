...
# @Time : 2021/11/25 10:32 下午
# @Author : daiyizheng
# @Version：V 0.1
# @File : albert_modeling.py
# @desc :

import torch
import torch.nn as nn
from transformers import AlbertModel, AlbertConfig, BertPreTrainedModel, AlbertPreTrainedModel
...
class ClsAlBert(AlbertPreTrainedModel):
    def __init__(self, config, args):
        ...
        ## -----albert---
        self.bert = AlbertModel(config=config)
